# Aquila Launcher v3.0.1

**refactor: полностью переработан дизайн навбара и уведомлений, добавлены эффектные свечения и улучшена эстетика интерфейса 🚀**
## 📥 Скачать последнюю версию
- [Windows](https://aquilarp.com/downloads/Aquila-Launcher-Setup-3.0.1.exe)
