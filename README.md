# Aquila Launcher v3.0.22

**feat: обновлены компоненты авторизации, исправлены проверки Java, добавлены улучшения в установку и подготовку ресурсов 🚀**
