# Aquila Launcher v2.0.88

**feat: Реализована система удаленного уведомления о новых версиях лаунчера 🚀, добавлены обработчики IPC для обновлений и загрузки ресурсов, обновлены компоненты и службы для повышения стабильности и расширяемости ⚙️**
## 📥 Скачать последнюю версию
- [Windows](https://aquilarp.com/downloads/Aquila-Launcher-Setup-2.0.88.exe)

## 🆕 Что нового в версии 2.0.88
