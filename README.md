# Aquila Launcher v2.0.101

**Добавлена поддержка настройки 2FA, улучшены страницы подтверждения и обновления пользователя 🔐**
## 📥 Скачать последнюю версию
- [Windows](https://aquilarp.com/downloads/Aquila-Launcher-Setup-2.0.101.exe)

## 🆕 Что нового в версии 2.0.101
