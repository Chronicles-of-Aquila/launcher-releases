# Aquila Launcher v2.0.108

**Добавлены визуальные эффекты для активных элементов и улучшена стилизация интерфейса 🚀**
## 📥 Скачать последнюю версию
- [Windows](https://aquilarp.com/downloads/Aquila-Launcher-Setup-2.0.108.exe)

## 🆕 Что нового в версии 2.0.108
